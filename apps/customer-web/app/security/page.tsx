...
export default function SecurityPage() {
  return <LegalPage title="Security at Darji." intro="How to use the service safely and report a concern." updatedOn="8 September 2026" companion={{ label: "Read the Privacy Policy", href: "/privacy" }} sections={[
    ...
    { id: "responsible-reporting", title: "Responsible reporting", audience: "Everyone", paragraphs: ["If you believe you found a security issue, send a clear description and reproduction steps to support@darji.in. Please avoid accessing, changing, or sharing other people’s information while investigating."] },
