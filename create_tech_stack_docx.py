...
BY_APP = [
    (
        "Backend",
        [
            "Node.js, Express 5, MongoDB, Mongoose, JWT, bcrypt, Socket.IO, Cloudinary, Firebase Admin, Multer, Zod, TypeScript",
        ],
    ),
    (
        "Customer App",
        [
            "Expo, React Native, React 19, NativeWind, Tailwind CSS, React Hook Form, Zod, Zustand, AsyncStorage, Expo Location, Expo Notifications, Expo Image Picker, Reanimated, Socket.IO client",
        ],
    ),
    (
        "Tailor App",
        [
            "Expo, React Native, React 19, NativeWind, Tailwind CSS, React Hook Form, Zod, Zustand, AsyncStorage, Expo Camera, Expo Location, Expo Notifications, ML Kit Face Detection, ML Kit Text Recognition, Reanimated, Socket.IO client",
        ],
    ),
    (
        "Delivery App",
        [
            "Expo, React Native, React 19, NativeWind, Tailwind CSS, React Hook Form, Zod, Zustand, AsyncStorage, Expo Location, Expo Notifications, Expo Image Picker, ML Kit Face Detection, ML Kit Text Recognition, Reanimated, WebView, Socket.IO client",
        ],
    ),
    (
        "Customer Web",
        [
            "Next.js 16, React 19, Tailwind CSS 4, React Query, Axios, React Hook Form, Zod, Zustand, Socket.IO client, Framer Motion, GSAP, Lenis, Three.js, React Three Fiber, Drei",
        ],
    ),
    (
        "Admin Panel",
        [
            "Next.js 16, React 19, Tailwind CSS 4, React Query, Axios, TanStack Table, Radix UI, Recharts, Sonner, CVA, clsx, tailwind-merge, Lucide, Zod, Zustand, Socket.IO client",
        ],
    ),
    (
        "Darji Web",
        [
            "Next.js 16, React 19, Tailwind CSS 4, GSAP, @gsap/react, Lenis, ESLint",
        ],
    ),
]
...
def build_document_xml() -> str:
    parts = [
        ...
        paragraph("Tech Stack By App", "Heading1"),
    ]

    for app_name, items in BY_APP:
        parts.append(paragraph(app_name, "Heading2"))
        for item in items:
            parts.append(bullet(item))

    parts.append(paragraph("Tech Stack By Purpose", "Heading1"))
    for category, stack in BY_PURPOSE:
        parts.append(bullet(f"{category}: {stack}"))

    parts.append(paragraph("Notes", "Heading1"))
    for note in NOTES:
        parts.append(bullet(note))
