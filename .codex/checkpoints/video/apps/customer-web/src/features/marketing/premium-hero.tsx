      ...
      <div className="shell relative z-10">
        <nav className="darji-navbar flex min-h-[5.5rem] items-center justify-between gap-5 py-4">
          ...
          <div className="flex items-center gap-3">
            <a href="tel:+919876543210" className="text-white hidden min-h-12 items-center gap-2 rounded-2xl border border-[#ece6df] bg-white px-5 text-sm font-black shadow-[0_12px_28px_rgba(8,17,31,0.05)] sm:flex">
